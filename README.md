...
* **8-Layer Language Detection:** A highly resilient pipeline to detect code-mixed and transliterated Indian languages:
  1. *L1 Unicode Script Ranges* (100% accurate for native scripts)
  2. *L3 N-gram Signature Matching*
  3. *L4 Franc Statistical NLP*
  4. *L5 Deep Word-Level Analysis* (Custom dictionaries, phonetic heuristics, and morpheme matching)
  5. *L6 Groq Llama-4-Scout (17B)*
  6. *L7 Groq Llama-3.3-70B*
  7. *L8 Groq Llama-3.1-8B*
  8. *L11 HuggingFace XLM-RoBERTa*
