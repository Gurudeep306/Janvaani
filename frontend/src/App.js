...
import {
  ...
  AshokaChakraSVG,
  GovBuildingSVG,
  TypingIllustrationSVG,
  VoiceIllustrationSVG,
  TrackIllustrationSVG,
  ParticleField,
  EmblemRingSVG,
  WaveDivider,
  TricolorBar,
...
const UI_STRINGS = {
  English: {
    ...
    grievanceFiledSuccessSub:
      "Recorded and routed. No further action required from the citizen.",
    ticketId: "Ticket ID",
    filedOn: "Filed On",
    ...
    languageVotes: "Language Detection Votes",
    citizenOriginalStatement: "Citizen's Original Statement",
  ...
  Hindi: {
    ...
    autoDetect: "AI स्वतः पहचानें",
    citizenStatement: "नागरिक का बयान",
    citizenStatementPlaceholder: "नागरिक ने जो बताया उसका विवरण दें…",
    locationRequired: "Location नागरिक का स्थान",
    locationRequiredBadge: "* आवश्यक",
    fetchingLocation: "Loading स्थान प्राप्त हो रहा है…",
    locationCaptured: "Done",
    tapToCapture: "Location नागरिक का स्थान कैप्चर करें",
    locationMandatory: "दर्ज करने से पहले स्थान अनिवार्य है।",
    attachEvidence: "Attachment साक्ष्य संलग्न करें",
    startVoice: "Voice आवाज़ कैप्चर शुरू करें",
    stopVoice: "Stop कैप्चर रोकें",
    capturingVoice: "नागरिक की आवाज़ रिकॉर्ड हो रही है…",
    filingRouting: "दर्ज और रूट किया जा रहा है…",
    captureToEnable: "Location दर्ज करने के लिए स्थान कैप्चर करें",
    ...
    grievanceFiledSuccessSub:
      "दर्ज और रूट किया गया। नागरिक को कोई और कार्रवाई आवश्यक नहीं।",
    ticketId: "टिकट ID",
    filedOn: "दर्ज तिथि",
    department: "Department विभाग",
    priority: "प्राथमिकता",
    language: "Language भाषा",
    complaintFiled: "Record दर्ज शिकायत",
    resolutionCommitted: "समाधान की प्रतिबद्धता",
    copyTicketId: "Copy टिकट ID कॉपी करें",
    copied: "Done कॉपी हो गया!",
    ...
    assignedTo: "Assigned नियुक्त",
    escalationChain: "Escalation एस्केलेशन श्रृंखला",
    statusHistory: "Copy स्थिति इतिहास",
    languageVotes: "Votes भाषा पहचान मत",
    citizenOriginalStatement: "नागरिक का मूल बयान",
    complaintOnRecord: "Record दर्ज शिकायत",
    slaDeadline: "SLA समय सीमा",
    confidence: "Search विश्वास",
    filed: "दर्ज:",
    ...
    autoDetectLabel: "AI भाषा स्वतः पहचानें",
  ...
  Telugu: {
    ...
    locationRequired: "Location పౌరుని స్థానం",
    locationRequiredBadge: "* అవసరం",
    fetchingLocation: "Loading స్థానం పొందుతోంది…",
    locationCaptured: "Done",
    tapToCapture: "Location పౌరుని స్థానం క్యాప్చర్ చేయండి",
    locationMandatory: "నమోదు చేయడానికి ముందు స్థానం తప్పనిసరి.",
    attachEvidence: "Attachment సాక్ష్యం జోడించండి",
    startVoice: "Voice వాయిస్ క్యాప్చర్ ప్రారంభించండి",
    stopVoice: "Stop క్యాప్చర్ ఆపండి",
    capturingVoice: "పౌరుని వాయిస్ రికార్డ్ అవుతోంది…",
    filingRouting: "నమోదు & రూటింగ్ జరుగుతోంది…",
    captureToEnable: "Location నమోదు చేయడానికి స్థానం క్యాప్చర్ చేయండి",
    ...
    grievanceFiledSuccessSub:
      "నమోదు మరియు రూట్ అయింది. పౌరునికి మరింత చర్య అవసరం లేదు.",
    ticketId: "టికెట్ ID",
    filedOn: "నమోదు తేదీ",
    department: "Department విభాగం",
    priority: "ప్రాధాన్యత",
    language: "Language భాష",
    complaintFiled: "Record నమోదైన ఫిర్యాదు",
    resolutionCommitted: "పరిష్కార నిబద్ధత",
    copyTicketId: "Copy టికెట్ ID కాపీ చేయండి",
    copied: "Done కాపీ అయింది!",
    ...
    assignedTo: "Assigned నియమించబడింది",
    escalationChain: "Escalation ఎస్కలేషన్ చైన్",
    statusHistory: "Copy స్థితి చరిత్ర",
    languageVotes: "Votes భాష గుర్తింపు ఓట్లు",
    citizenOriginalStatement: "పౌరుని అసలు వాక్యం",
    complaintOnRecord: "Record నమోదైన ఫిర్యాదు",
    slaDeadline: "SLA గడువు",
    confidence: "Search విశ్వాసం",
    filed: "నమోదు:",
    ...
    autoDetectLabel: "AI భాష స్వయంచాలకంగా గుర్తించండి",
  ...
  Tamil: {
    ...
    autoDetect: "AI தானாக கண்டறி",
    citizenStatement: "குடிமகன் கூற்று",
    citizenStatementPlaceholder: "குடிமகன் தெரிவித்ததை விவரிக்கவும்…",
    locationRequired: "Location குடிமகன் இடம்",
    locationRequiredBadge: "* தேவை",
    fetchingLocation: "Loading இடம் பெறப்படுகிறது…",
    locationCaptured: "Done",
    tapToCapture: "Location குடிமகன் இடத்தை பதிவு செய்யவும்",
    locationMandatory: "பதிவு செய்வதற்கு முன் இடம் கட்டாயம்.",
    attachEvidence: "Attachment ஆதாரம் இணைக்கவும்",
    startVoice: "Voice குரல் பதிவு தொடங்கு",
    stopVoice: "Stop பதிவை நிறுத்து",
    capturingVoice: "குடிமகன் குரல் பதிவாகிறது…",
    filingRouting: "பதிவு மற்றும் திசைதிருப்பல்…",
    captureToEnable: "Location பதிவு செய்ய இடத்தை பதிவு செய்யவும்",
    ...
    grievanceFiledSuccessSub:
      "பதிவு மற்றும் திசைதிருப்பல் ஆயிற்று. குடிமகனுக்கு மேலும் நடவடிக்கை தேவையில்லை.",
    ticketId: "டிக்கெட் ID",
    filedOn: "பதிவு தேதி",
    department: "Department துறை",
    priority: "முன்னுரிமை",
    language: "Language மொழி",
    complaintFiled: "Record பதிவான புகார்",
    resolutionCommitted: "தீர்வு உறுதிமொழி",
    copyTicketId: "Copy டிக்கெட் ID நகலெடு",
    copied: "Done நகலெடுக்கப்பட்டது!",
    fileAnother: "+ மேலும் ஒரு குறை பதிவு",
    trackTitle: "புகாரை கண்காணிக்க",
    trackSub: "நிலை சரிபார்க்க டிக்கெட் ID உள்ளிடவும்",
    ticketPlaceholder: "JV-XXXXXXXX",
    searching: "தேடுகிறது…",
    track: "Search கண்காணி",
    enterTicketId: "டிக்கெட் ID உள்ளிடவும்.",
    ticketNotFound: "டிக்கெட் கிடைக்கவில்லை. ID சரிபார்க்கவும்.",
    assignedTo: "Assigned நியமிக்கப்பட்டது",
    escalationChain: "Escalation அதிகரிப்பு சங்கிலி",
    statusHistory: "Copy நிலை வரலாறு",
    languageVotes: "Votes மொழி கண்டறிதல் வாக்குகள்",
    citizenOriginalStatement: "குடிமகனின் அசல் கூற்று",
    complaintOnRecord: "Record பதிவான புகார்",
    slaDeadline: "SLA காலக்கெடு",
    confidence: "Search நம்பகத்தன்மை",
    filed: "பதிவு:",
    ...
    autoDetectLabel: "AI மொழியை தானாக கண்டறி",
  ...
  Kannada: {
    ...
    autoDetect: "AI ಸ್ವಯಂ ಪತ್ತೆ",
    citizenStatement: "ನಾಗರಿಕರ ಹೇಳಿಕೆ",
    citizenStatementPlaceholder: "ನಾಗರಿಕರು ವರದಿ ಮಾಡಿದ್ದನ್ನು ವಿವರಿಸಿ…",
    locationRequired: "Location ನಾಗರಿಕರ ಸ್ಥಳ",
    locationRequiredBadge: "* ಅಗತ್ಯ",
    fetchingLocation: "Loading ಸ್ಥಳ ಪಡೆಯಲಾಗುತ್ತಿದೆ…",
    locationCaptured: "Done",
    tapToCapture: "Location ನಾಗರಿಕರ ಸ್ಥಳ ಕ್ಯಾಪ್ಚರ್ ಮಾಡಿ",
    locationMandatory: "ದಾಖಲಿಸಲು ಮೊದಲು ಸ್ಥಳ ಕಡ್ಡಾಯ.",
    attachEvidence: "Attachment ಸಾಕ್ಷ್ಯ ಲಗತ್ತಿಸಿ",
    startVoice: "Voice ಧ್ವನಿ ಕ್ಯಾಪ್ಚರ್ ಪ್ರಾರಂಭಿಸಿ",
    stopVoice: "Stop ಕ್ಯಾಪ್ಚರ್ ನಿಲ್ಲಿಸಿ",
    capturingVoice: "ನಾಗರಿಕರ ಧ್ವನಿ ರೆಕಾರ್ಡ್ ಆಗುತ್ತಿದೆ…",
    filingRouting: "ದಾಖಲಿಸಲಾಗುತ್ತಿದೆ…",
    captureToEnable: "Location ದಾಖಲಿಸಲು ಸ್ಥಳ ಕ್ಯಾಪ್ಚರ್ ಮಾಡಿ",
    ...
    department: "Department ವಿಭಾಗ",
    priority: "ಆದ್ಯತೆ",
    language: "Language ಭಾಷೆ",
    complaintFiled: "Record ದಾಖಲಾದ ದೂರು",
    resolutionCommitted: "ಪರಿಹಾರ ಬದ್ಧತೆ",
    copyTicketId: "Copy ಟಿಕೆಟ್ ID ನಕಲಿಸಿ",
    copied: "Done ನಕಲಿಸಲಾಗಿದೆ!",
    ...
    track: "Search ಟ್ರ್ಯಾಕ್",
    enterTicketId: "ಟಿಕೆಟ್ ID ನಮೂದಿಸಿ.",
    ticketNotFound: "ಟಿಕೆಟ್ ಕಂಡುಬಂದಿಲ್ಲ. ID ಪರಿಶೀಲಿಸಿ.",
    assignedTo: "Assigned ನಿಯೋಜಿಸಲಾಗಿದೆ",
    escalationChain: "Escalation ಎಸ್ಕಲೇಶನ್ ಸರಪಳಿ",
    statusHistory: "Copy ಸ್ಥಿತಿ ಇತಿಹಾಸ",
    languageVotes: "Votes ಭಾಷಾ ಗುರುತಿಸುವಿಕೆ ಮತಗಳು",
    citizenOriginalStatement: "ನಾಗರಿಕರ ಮೂಲ ಹೇಳಿಕೆ",
    complaintOnRecord: "Record ದಾಖಲಾದ ದೂರು",
    slaDeadline: "SLA ಗಡುವು",
    confidence: "Search ವಿಶ್ವಾಸ",
    filed: "ದಾಖಲಾಗಿದೆ:",
    ...
    autoDetectLabel: "AI ಭಾಷೆಯನ್ನು ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಪತ್ತೆ ಮಾಡಿ",
  ...
  Bengali: {
    ...
    autoDetect: "AI স্বয়ংক্রিয় সনাক্ত",
    citizenStatement: "নাগরিকের বিবৃতি",
    citizenStatementPlaceholder: "নাগরিক কী জানিয়েছেন তা বর্ণনা করুন…",
    locationRequired: "Location নাগরিকের অবস্থান",
    locationRequiredBadge: "* প্রয়োজন",
    fetchingLocation: "Loading অবস্থান নেওয়া হচ্ছে…",
    locationCaptured: "Done",
    tapToCapture: "Location নাগরিকের অবস্থান ক্যাপচার করুন",
    locationMandatory: "নথিভুক্তির আগে অবস্থান আবশ্যক।",
    attachEvidence: "Attachment প্রমাণ সংযুক্ত করুন",
    startVoice: "Voice কণ্ঠস্বর ক্যাপচার শুরু করুন",
    stopVoice: "Stop ক্যাপচার বন্ধ করুন",
    capturingVoice: "নাগরিকের কণ্ঠস্বর রেকর্ড হচ্ছে…",
    filingRouting: "নথিভুক্ত ও রুট করা হচ্ছে…",
    captureToEnable: "Location নথিভুক্তি সক্ষম করতে অবস্থান ক্যাপচার করুন",
    ...
    grievanceFiledSuccessSub:
      "নথিভুক্ত ও রুট করা হয়েছে। নাগরিকের আর কোনো পদক্ষেপ প্রয়োজন নেই।",
    ticketId: "টিকিট ID",
    filedOn: "দাখিলের তারিখ",
    department: "Department বিভাগ",
    priority: "অগ্রাধিকার",
    language: "Language ভাষা",
    complaintFiled: "Record দাখিলকৃত অভিযোগ",
    resolutionCommitted: "সমাধানের প্রতিশ্রুতি",
    copyTicketId: "Copy টিকিট ID কপি করুন",
    copied: "Done কপি হয়েছে!",
    fileAnother: "+ আরেকটি অভিযোগ দাখিল করুন",
    trackTitle: "অভিযোগ ট্র্যাক করুন",
    trackSub: "অবস্থা পরীক্ষা করতে টিকিট ID লিখুন",
    ticketPlaceholder: "JV-XXXXXXXX",
    searching: "খোঁজা হচ্ছে…",
    track: "Search ট্র্যাক",
    enterTicketId: "টিকিট ID লিখুন।",
    ticketNotFound: "টিকিট পাওয়া যায়নি। ID পরীক্ষা করুন।",
    assignedTo: "Assigned নিযুক্ত",
    escalationChain: "Escalation এস্কেলেশন চেইন",
    statusHistory: "Copy অবস্থার ইতিহাস",
    languageVotes: "Votes ভাষা সনাক্তকরণ ভোট",
    citizenOriginalStatement: "নাগরিকের মূল বিবৃতি",
    complaintOnRecord: "Record নথিভুক্ত অভিযোগ",
    slaDeadline: "SLA সময়সীমা",
    confidence: "Search আস্থা",
    filed: "দাখিল:",
    ...
    autoDetectLabel: "AI ভাষা স্বয়ংক্রিয়ভাবে সনাক্ত করুন",
  ...
  Marathi: {
    ...
    autoDetect: "AI स्वयं ओळखा",
    citizenStatement: "नागरिकाचे निवेदन",
    citizenStatementPlaceholder: "नागरिकाने सांगितलेले वर्णन करा…",
    locationRequired: "Location नागरिकाचे स्थान",
    locationRequiredBadge: "* आवश्यक",
    fetchingLocation: "Loading स्थान मिळवत आहे…",
    locationCaptured: "Done",
    tapToCapture: "Location नागरिकाचे स्थान कॅप्चर करा",
    locationMandatory: "नोंदणीपूर्वी स्थान अनिवार्य आहे.",
    attachEvidence: "Attachment पुरावा जोडा",
    startVoice: "Voice आवाज कॅप्चर सुरू करा",
    stopVoice: "Stop कॅप्चर थांबवा",
    capturingVoice: "नागरिकाचा आवाज रेकॉर्ड होत आहे…",
    filingRouting: "नोंदवत आणि पाठवत आहे…",
    captureToEnable: "Location नोंदणीसाठी स्थान कॅप्चर करा",
    ...
    grievanceFiledSuccessSub:
      "नोंदवले आणि मार्गस्थ केले. नागरिकाला आणखी कारवाई आवश्यक नाही.",
    ticketId: "तिकीट ID",
    filedOn: "दाखल तारीख",
    department: "Department विभाग",
    priority: "प्राधान्य",
    language: "Language भाषा",
    complaintFiled: "Record दाखल तक्रार",
    resolutionCommitted: "निराकरण वचनबद्धता",
    copyTicketId: "Copy तिकीट ID कॉपी करा",
    copied: "Done कॉपी झाले!",
    ...
    assignedTo: "Assigned नियुक्त",
    escalationChain: "Escalation एस्केलेशन साखळी",
    statusHistory: "Copy स्थिती इतिहास",
    languageVotes: "Votes भाषा ओळख मते",
    citizenOriginalStatement: "नागरिकाचे मूळ निवेदन",
    complaintOnRecord: "Record नोंदवलेली तक्रार",
    ...
    autoDetectLabel: "AI भाषा स्वयंचलितपणे ओळखा",
  ...
  Odia: {
    ...
    autoDetect: "AI ସ୍ୱୟଂ ଚିହ୍ନଟ",
    citizenStatement: "ନାଗରିକଙ୍କ ବିବୃତ୍ତି",
    citizenStatementPlaceholder: "ନାଗରିକ ଯାହା ଜଣାଇଛନ୍ତି ବର୍ଣ୍ଣନା କରନ୍ତୁ…",
    locationRequired: "Location ନାଗରିକଙ୍କ ଅବସ୍ଥାନ",
    locationRequiredBadge: "* ଆବଶ୍ୟକ",
    fetchingLocation: "Loading ଅବସ୍ଥାନ ଆଣୁଛି…",
    locationCaptured: "Done",
    tapToCapture: "Location ନାଗରିକଙ୍କ ଅବସ୍ଥାନ ଗ୍ରହଣ କରନ୍ତୁ",
    locationMandatory: "ଦାଖଲ ପୂର୍ବରୁ ଅବସ୍ଥାନ ବାଧ୍ୟତାମୂଳକ।",
    attachEvidence: "Attachment ସାକ୍ଷ୍ୟ ସଂଲଗ୍ନ କରନ୍ତୁ",
    startVoice: "Voice ଭଏସ୍ ଗ୍ରହଣ ଆରମ୍ଭ",
    stopVoice: "Stop ଗ୍ରହଣ ବନ୍ଦ",
    capturingVoice: "ନାଗରିକଙ୍କ ଭଏସ୍ ରେକର୍ଡ ହେଉଛି…",
    filingRouting: "ଦାଖଲ ହେଉଛି…",
    captureToEnable: "Location ଦାଖଲ ପାଇଁ ଅବସ୍ଥାନ ଗ୍ରହଣ କରନ୍ତୁ",
    ...
    grievanceFiledSuccessSub:
      "ଦାଖଲ ଓ ରୁଟ୍ ହୋଇଛି। ନାଗରିକଙ୍କ ଆଉ କ୍ରିୟା ଆବଶ୍ୟକ ନୁହେଁ।",
    ticketId: "ଟିକେଟ ID",
    filedOn: "ଦାଖଲ ତାରିଖ",
    department: "Department ବିଭାଗ",
    priority: "ଅଗ୍ରାଧିକାର",
    language: "Language ଭାଷା",
    complaintFiled: "Record ଦାଖଲ ଅଭିଯୋଗ",
    resolutionCommitted: "ସମାଧାନ ପ୍ରତିଶ୍ରୁତି",
    copyTicketId: "Copy ଟିକେଟ ID ନକଲ",
    copied: "Done ନକଲ ହୋଇଛି!",
    ...
    assignedTo: "Assigned ନ୍ୟସ୍ତ",
    escalationChain: "Escalation ଏସ୍କାଲେଶନ ଚେନ",
    statusHistory: "Copy ସ୍ଥିତି ଇତିହାସ",
    languageVotes: "Votes ଭାଷା ଚିହ୍ନଟ ଭୋଟ",
    citizenOriginalStatement: "ନାଗରିକଙ୍କ ମୂଳ ବିବୃତ୍ତି",
    complaintOnRecord: "Record ଦାଖଲ ଅଭିଯୋଗ",
    slaDeadline: "SLA ସୀମା",
    confidence: "Search ବିଶ୍ୱାସ",
    filed: "ଦାଖଲ:",
    ...
    autoDetectLabel: "AI ଭାଷା ସ୍ୱୟଂ ଚିହ୍ନଟ",
...
const getSeverityStyle = (s = "") => {
  ...
  if (u === "MEDIUM")
    return { bg: "rgba(234,179,8,0.12)", color: "#eab308", border: "#eab308" };
...
export default function App() {
  ...
  useEffect(() => {
    const id = setInterval(
      () => setTitleIdx((p) => (p + 1) % JANVAANI_TITLES.length),
      12000
    );
    ...
    const fallbackToIP = async () => {
      try {
        ...
        if (d.latitude && d.longitude) {
          ...
          setLocationLabel(
            parts.length ? parts.join(", ") + " (approx)" : `${lat}, ${lng}`
          );
        } else throw new Error("No coords");
      } catch {
        alert(
          "Could not determine location. Please check your browser and OS location settings, then try again."
        );
      } finally {
    ...
    navigator.geolocation.getCurrentPosition(
      async (pos) => {
        ...
        try {
          ...
          const state = a.state || "";
          const parts = [area, city !== area ? city : "", state].filter(
            Boolean
          );
  ...
  const startAudioVisualization = useCallback(async () => {
    try {
      ...
      const update = (timestamp) => {
        ...
        const bars = 32,
          sliceW = Math.floor(bufLen / bars),
          levels = [];
        let totalVol = 0;
        for (let i = 0; i < bars; i++) {
          let sum = 0;
          for (let j = 0; j < sliceW; j++) sum += dataArr[i * sliceW + j];
          const avg = sum / sliceW / 255;
          levels.push(avg);
          totalVol += avg;
        }
        setWaveformData(levels);
        setAvgVolume(totalVol / bars);
        animFrameRef.current = requestAnimationFrame(update);
      };
      animFrameRef.current = requestAnimationFrame(update);
    } catch (err) {
  ...
  const startListening = useCallback(async () => {
    ...
    const createRec = () => {
      ...
      const langObj =
        spokenLang === "AUTO"
          ? null
          : ALL_LANGS.find((l) => l.code === spokenLang);
      ...
      rec.onresult = (e) => {
        ...
        setCitizenStatement(finalTranscript.current + interim);
      ...
      rec.onerror = (e) => {
        ...
        if (e.error === "no-speech") {
          if (isListeningRef.current) retry(200);
          ...
          if (isListeningRef.current) retry(500);
        }
      };
      rec.onend = () => {
        setInterimText("");
  ...
  const fileGrievance = async () => {
    ...
    try {
      ...
      if (!ct?.includes("application/json"))
        throw new Error(
          `Backend response invalid. Verify server at ${API_BASE_URL}.`
        );
  ...
  const trackComplaint = async () => {
    ...
    if (!id) {
      setTrackError(t(uiLang, "enterTicketId"));
      return;
    }
    ...
    try {
      ...
      if (resp.status === 404) {
        setTrackError(`${t(uiLang, "ticketNotFound")}: "${id}"`);
  ...
  const detectedScriptLang = useMemo(
    () => (citizenStatement ? detectLangFromScript(citizenStatement) : null),
    [citizenStatement]
  );
  const renderResult = () => {
      ...
      <div style={S.resultCard}>
        ...
        >
          <div
            style={{
              ...
              justifyContent: "center",
              animation:
                "successScale 0.6s cubic-bezier(0.175, 0.885, 0.32, 1.275)",
            }}
          >
        ...
        >
          ...
          <div>
            ...
            >
              {t(uiLang, "grievanceFiledSuccess")}
            </div>
            <div style={{ fontSize: 12, color: "#64748b" }}>
              {t(uiLang, "grievanceFiledSuccessSub")}
            </div>
          </div>
        </div>
        <div
        ...
        <div style={{ display: "flex", gap: 12, marginBottom: 16 }}>
          ...
          >
            ...
            <div style={{ ...S.infoVal, color: "#38bdf8" }}>
              {result.officialDeptName || result.department}
            </div>
          </div>
          <div
            style={{
          ...
          >
            ...
            <div style={{ ...S.infoVal, fontSize: 13 }}>
  ...
  const renderTrackResult = () => {
    ...
    const chain = Array.isArray(trackResult.escalation_chain)
      ? trackResult.escalation_chain
      : [];
      ...
      <div style={S.resultCard}>
        ...
        >
          <div>
            ...
            >
              {trackResult.ticket_id}
            </div>
            <div style={{ fontSize: 12, color: "#64748b", marginTop: 4 }}>
              {t(uiLang, "filed")} {trackResult.created_at_ist}
            </div>
          </div>
          <div
            style={{
        ...
        <div style={{ display: "flex", gap: 12, marginBottom: 16 }}>
          <div style={{ ...S.infoCell, flex: 2 }}>
            <div style={S.infoLbl}>{t(uiLang, "department")}</div>
            <div style={{ ...S.infoVal, color: "#38bdf8", fontSize: 13 }}>
              {trackResult.official_dept_name || trackResult.department}
            </div>
          </div>
        ...
        {(trackResult.citizen_name ||
          trackResult.citizen_phone ||
          trackResult.full_address) && (
          <div
            style={{ ...S.block, display: "flex", gap: 24, flexWrap: "wrap" }}
          >
            {trackResult.citizen_name && (
              <div>
                <div style={S.blockLbl}>Citizen Name</div>
                <div style={{ ...S.blockVal, fontWeight: 700 }}>
                  {trackResult.citizen_name}
                </div>
              </div>
            )}
            {trackResult.citizen_phone && (
              <div>
                <div style={S.blockLbl}>Phone Phone</div>
                <div style={{ ...S.blockVal, fontWeight: 700 }}>
                  {trackResult.citizen_phone}
                </div>
              </div>
            ...
            {trackResult.full_address && (
              <div style={{ flex: 1 }}>
                <div style={S.blockLbl}>Location</div>
                <div style={{ ...S.blockVal, color: "#38bdf8", fontSize: 12 }}>
                  {trackResult.full_address}
                </div>
              </div>
            )}
        ...
        {trackResult.raw_text && (
          <div style={S.block}>
            <div style={S.blockLbl}>
              {t(uiLang, "citizenOriginalStatement")}
            </div>
            <div
              style={{
                ...S.blockVal,
        ...
        {trackResult.formal_grievance && (
          <div style={S.block}>
            ...
            <div style={{ ...S.blockVal, fontSize: 13, lineHeight: 1.7 }}>
              {trackResult.formal_grievance}
            </div>
          </div>
        )}
        {trackResult.nodal_officer && (
          ...
          >
            <div style={{ ...S.blockLbl, color: "#f97316" }}>
              {t(uiLang, "assignedTo")}
            </div>
            <div style={{ ...S.blockVal, color: "#fdba74" }}>
              {trackResult.nodal_officer}
            </div>
          </div>
        )}
        ...
        >
          <Globe2 size={12} /> Portal: {trackResult.portal_to_log || "—"} · Act:{" "}
          {trackResult.reference_act || "—"}
        </div>
      </div>
    );
  };
    ...
    >
      ...
      >
        <div
          style={{
            fontWeight: 700,
            color: spokenLang === "AUTO" ? "#818cf8" : "#94a3b8",
          }}
        >
          {t(uiLang, "autoDetectLabel")}
        </div>
        <div style={{ fontSize: 10, color: "#475569" }}>
          {t(uiLang, "autoDetectSub")}
        </div>
      </button>
      ...
      <div style={S.root}>
        ...
        <div style={S.topBar} className="top-bar">
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <span style={S.logo} key={titleIdx}>
              {JANVAANI_TITLES[titleIdx]}
            </span>
            <span className="operator-badge">
              {t(uiLang, "operatorPortal")}
            </span>
          </div>
          <div className="top-actions">
            {UI_SWITCHER_LANGS.map((l) => (
              <button
                ...
                style={{
                  ...S.langBtn,
                  ...(uiLang === l ? S.langBtnActive : {}),
                }}
              >
                {ALL_LANGS.find((x) => x.code === l)?.label || l}
              </button>
            ))}
            <a
              ...
              style={{
                padding: "6px 14px",
                borderRadius: 10,
                border: "1px solid rgba(242,78,78,0.3)",
                background:
                  "linear-gradient(135deg, rgba(242,78,78,0.1), rgba(242,78,78,0.04))",
                color: "#f24e4e",
                fontSize: 12,
                fontWeight: 700,
                textDecoration: "none",
                ...
                boxShadow: "0 0 20px rgba(242,78,78,0.05)",
              }}
            >
        ...
        {mode === "none" && (
          <div style={S.homeWrap}>
            ...
            >
              <AshokaChakraSVG
                size={500}
                style={{ animation: "ringSpin 120s linear infinite" }}
              />
            </div>
            <div
              style={{
                ...
                <div style={{ position: "relative" }}>
                  <div
                    style={{
                      ...
                      borderRadius: "50%",
                      background:
                        "linear-gradient(135deg, rgba(56,189,248,0.15), rgba(99,102,241,0.15), rgba(34,197,94,0.1))",
            ...
            <WaveDivider
              style={{ maxWidth: 600, margin: "0 auto 24px", opacity: 0.4 }}
            />
            <div style={{ ...S.homeHero, position: "relative", zIndex: 1 }}>
              ...
              <div
                style={{
                  ...
                  borderRadius: 20,
                  background:
                    "linear-gradient(135deg, rgba(56,189,248,0.06), rgba(99,102,241,0.04), rgba(34,197,94,0.03))",
                ...
                {[
                  ...
                  <div
                    ...
                    style={{
                      ...
                      position: "relative",
                      cursor: "default",
                      animation: `statCount 0.6s cubic-bezier(0.34,1.56,0.64,1) ${
                        0.1 + idx * 0.1
                      }s both`,
                    }}
                  >
            ...
            <div style={{ ...S.cardsRow, position: "relative", zIndex: 1 }}>
              <div
                ...
                style={{
                  ...
                  animation:
                    "slideInLeft 0.7s cubic-bezier(0.34,1.56,0.64,1) 0.1s both",
                }}
              ...
              >
                ...
                <div
                  style={{
                    ...
                    height: "100%",
                    background:
                      "linear-gradient(180deg, rgba(56,189,248,0.08) 0%, transparent 50%)",
                    borderRadius: 28,
                    pointerEvents: "none",
                  }}
                />
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  >
                    <div
                      style={{
                        ...
                        borderRadius: 18,
                        background:
                          "linear-gradient(135deg, rgba(56,189,248,0.18), rgba(56,189,248,0.06))",
                        border: "1px solid rgba(56,189,248,0.3)",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        boxShadow:
                          "0 8px 24px rgba(56,189,248,0.15), 0 0 40px rgba(56,189,248,0.05)",
                      ...
                      {[0, 1, 2].map((i) => (
                        <div
                          ...
                          style={{
                            ...
                            background: "#38bdf8",
                            opacity: 0.3 + i * 0.2,
                            animation: `dotBounce 1.5s ease-in-out ${
                              i * 0.2
                            }s infinite`,
                          }}
                        />
                  ...
                  <div style={S.modeCardTitle}>
                    {t(uiLang, "recordByTyping")}
                  </div>
                  <div style={S.modeCardSub}>
                    {t(uiLang, "recordByTypingSub")}
                  </div>
                  <div
                    style={{
                      display: "flex",
              ...
              <div
                ...
                style={{
                  ...
                  transform: "translateY(0)",
                  animation:
                    "fadeUp 0.7s cubic-bezier(0.34,1.56,0.64,1) 0.25s both",
                }}
              ...
              >
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  >
                    <div
                      style={{
                        ...
                        justifyContent: "center",
                        boxShadow:
                          "0 8px 24px rgba(16,185,129,0.15), 0 0 40px rgba(16,185,129,0.05)",
                      ...
                      {[0, 1, 2, 3, 4].map((i) => (
                        <div
                          ...
                          style={{
                            ...
                            height: 8 + i * 5,
                            borderRadius: 2,
                            background: `rgba(16,185,129,${0.25 + i * 0.12})`,
                  ...
                  <div style={S.modeCardTitle}>
                    {t(uiLang, "recordByVoice")}
                  </div>
                  <div style={S.modeCardSub}>
                    {t(uiLang, "recordByVoiceSub")}
                  </div>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <ChevronRight
                      ...
                      color="#10b981"
                      style={{
                        animation: "arrowNudge 2s ease-in-out 0.3s infinite",
                      }}
                    />
                  </div>
                </div>
              ...
              <div
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(160deg, rgba(99,102,241,0.08), rgba(5,14,30,0.9))",
                  borderTop: "2px solid rgba(99,102,241,0.4)",
                  transform: "translateY(0)",
                  animation:
                    "slideInRight 0.7s cubic-bezier(0.34,1.56,0.64,1) 0.4s both",
                }}
              ...
              >
                ...
                <div style={{ position: "relative", zIndex: 1 }}>
                  ...
                  >
                    <div
                      style={{
                        ...
                        justifyContent: "center",
                        boxShadow:
                          "0 8px 24px rgba(99,102,241,0.15), 0 0 40px rgba(99,102,241,0.05)",
                  ...
                  <div style={S.modeCardTitle}>
                    {t(uiLang, "trackComplaint")}
                  </div>
                  <div style={S.modeCardSub}>
                    {t(uiLang, "trackComplaintSub")}
                  </div>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    <ChevronRight
                      ...
                      color="#818cf8"
                      style={{
                        animation: "arrowNudge 2s ease-in-out 0.6s infinite",
                      }}
                    />
                  </div>
                </div>
            ...
            >
              ...
              <div
                style={{
                  ...
                  borderRadius: 16,
                  background:
                    "linear-gradient(135deg, rgba(56,189,248,0.04), rgba(99,102,241,0.03), rgba(34,197,94,0.02))",
                  border: "1px solid rgba(255,255,255,0.06)",
              ...
              >
                ...
                >
                  Your voice matters. Quick, secure, and accessible grievance
                  management for every citizen across India.
                </div>
                <div style={{ fontSize: 11, color: "#334155", marginTop: 10 }}>
                  Powered by AI-driven multi-language detection · Compliant with
                  Government of India IT Standards
                </div>
          ...
          <div style={S.formWrap}>
            <div style={S.formPanel} className="form-panel-glow">
              ...
              <div style={{ animation: "fieldReveal 0.5s ease forwards" }}>
                <button onClick={reset} style={S.backBtn}>
                  <ArrowLeft
                    size={16}
              ...
              <div
                style={{
                  ...
                  alignItems: "center",
                  gap: 16,
                  animation: "fieldReveal 0.5s ease 0.05s both",
                }}
              >
                <div
                  style={{
                ...
                >
                  {mode === "write" ? (
                    <FileText size={24} color="#38bdf8" strokeWidth={1.5} />
                  ) : (
                    <Mic size={24} color="#a855f7" strokeWidth={1.5} />
                  )}
                </div>
                <div>
                  <div style={S.panelTitle}>
                    {mode === "write"
                      ? t(uiLang, "recordByTypingFull")
                      : t(uiLang, "recordByVoiceFull")}
                  </div>
              ...
              <div
                style={{
                  ...S.fieldGroup,
                  animation: "fieldReveal 0.5s ease 0.1s both",
                }}
              >
                <div
                  style={{
                ...
                <div style={S.fieldRow} className="field-row">
                  <div style={S.fieldWrap}>
                    ...
                    <input
                      style={S.inp}
                      placeholder={t(uiLang, "citizenNamePlaceholder")}
                      value={citizenName}
                  ...
                  <div style={S.fieldWrap}>
                    ...
                    <input
                      style={S.inp}
                      placeholder={t(uiLang, "citizenPhonePlaceholder")}
                      value={citizenPhone}
                      inputMode="tel"
                      maxLength={15}
                      onChange={(e) =>
              ...
              <div
                style={{
                  ...S.fieldGroup,
                  ...S.fieldRow,
                  animation: "fieldReveal 0.5s ease 0.15s both",
                  position: "relative",
                  zIndex: 10,
                }}
                className="field-row"
                      ...
                      <span>
                        {spokenLang === "AUTO" ? (
                          <span style={{ color: "#818cf8", fontWeight: 700 }}>
                            {t(uiLang, "autoDetect")}
                            {detectedScriptLang &&
                            detectedScriptLang !== "English"
                              ? ` → ${detectedScriptLang}`
                              : ""}
                          </span>
                        ) : (
                          ALL_LANGS.find((l) => l.code === spokenLang)?.label ||
                          spokenLang
                        )}
                      </span>
              ...
              {mode === "speak" && (
                <div
                  style={{
                    ...S.fieldGroup,
                    animation: "fieldReveal 0.5s ease 0.2s both",
                  }}
                >
                  <div
                    style={{
                  ...
                  {!listening ? (
                    <button style={S.micStartBtn} onClick={startListening}>
                      <Mic
                        size={18}
                    ...
                    <div style={S.listeningBox}>
                      ...
                      >
                        ...
                        >
                          <div
                            style={{
                              ...
                              transform: `scale(${1 + avgVolume * 1.2})`,
                          ...
                          {[0, 1, 2].map((i) => (
                            <div
                              ...
                              style={{
                                ...
                                height: 80,
                                borderRadius: "50%",
                                border: `1.5px solid rgba(14,165,233,${
                                  0.35 - i * 0.1
                                })`,
                                animation: `voiceRipple ${
                                  2 + i * 0.4
                                }s ease-out ${i * 0.5}s infinite`,
                              }}
                            />
                          ))}
                          <div
                            style={{
                              ...
                              borderRadius: "50%",
                              background:
                                "linear-gradient(135deg, rgba(14,165,233,0.85), rgba(99,102,241,0.85))",
                              display: "flex",
                              alignItems: "center",
                              justifyContent: "center",
                              zIndex: 2,
                        ...
                        >
                          ...
                          >
                            {String(Math.floor(recordingSecs / 60)).padStart(
                              2,
                              "0"
                            )}
                        ...
                        >
                          {waveformData.map((level, i) => {
                            const h = Math.max(3, level * 56),
                              centerDist = Math.abs(i - 15.5) / 16,
                              hue = 200 - centerDist * 40,
                              saturation = 85 + level * 15,
                              lightness = 50 + level * 20;
                            return (
                              <div
                                key={i}
                                style={{
                        ...
                        >
                          <div
                            style={{
                              height: "100%",
                              width: `${Math.min(100, avgVolume * 200)}%`,
                              borderRadius: 2,
                              background: `linear-gradient(90deg, #0ea5e9, ${
                                avgVolume > 0.4
                                  ? "#22c55e"
                                  : avgVolume > 0.2
                                  ? "#6366f1"
                              ...
                              transition:
                                "width 0.2s cubic-bezier(0.25,0.46,0.45,0.94), background 0.5s ease",
                            }}
                          />
                        </div>
                        {spokenLang === "AUTO" && detectedScriptLang && (
                          ...
                          >
                            <Languages size={12} /> Detected:{" "}
                            <strong>{detectedScriptLang}</strong>
                          </div>
                        )}
                        {interimText && (
                          <div
                        ...
                        <button style={S.micStopBtn} onClick={stopListening}>
                          <MicOff
                            size={16}
                            style={{ marginRight: 6, verticalAlign: "middle" }}
                          />
              ...
              <div
                style={{
                  ...S.fieldGroup,
                  animation: "fieldReveal 0.5s ease 0.25s both",
                  position: "relative",
                  zIndex: 1,
                }}
              >
                ...
                <textarea
                  style={S.textarea}
                  placeholder={t(uiLang, "citizenStatementPlaceholder")}
                ...
                {citizenStatement &&
                  ...
                  detectedScriptLang && (
                    ...
                    >
                      <span>Detected</span>
                      <span>
                        Script detected: <strong>{detectedScriptLang}</strong> —
                        will be used for AI processing
                      </span>
                    </div>
                  )}
              </div>
              <div
                style={{
                  ...S.fieldGroup,
                  animation: "fieldReveal 0.5s ease 0.3s both",
                }}
              >
                <label style={S.lbl}>
                  {t(uiLang, "locationRequired")}{" "}
                  <span style={{ color: "#ef4444", marginLeft: 4 }}>
                    {t(uiLang, "locationRequiredBadge")}
                  </span>
                </label>
                <button
                  ...
                  style={{
                    ...S.locationBtn,
                    ...(location
                      ? S.locationBtnSuccess
                      : S.locationBtnRequired),
                  }}
                >
                  {isFetchingLoc ? (
                    <>
                    ...
                    <>
                      <CheckCircle2
                        ...
                        style={{ marginRight: 8 }}
                      />
                      {t(uiLang, "locationCaptured")}{" "}
                      {locationLabel || location}
                    </>
                  ) : (
                    <>
                      <MapPin size={18} style={{ marginRight: 8 }} />
                      {t(uiLang, "tapToCapture")}
                    </>
                  )}
                </button>
                {!location && (
                ...
                <div style={{ marginTop: 10 }}>
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (!file) return;
                      if (
                        !ACCEPTED_ATTACHMENT_TYPES.some((prefix) =>
                          file.type.startsWith(prefix)
                        )
                      ) {
                        alert(
                          "Unsupported file type. Please upload image, video, audio, or PDF."
                        );
                        e.target.value = "";
                        return;
                      }
                      if (file.size > MAX_ATTACHMENT_BYTES) {
                        alert("File too large. Maximum allowed size is 8 MB.");
                        e.target.value = "";
                        return;
                      }
                      setAttachment(file);
                ...
                <div style={{ animation: "fieldReveal 0.5s ease 0.35s both" }}>
                  <button
                    style={{
                      ...S.submitBtn,
                      opacity:
                        isAnalyzing || !citizenStatement.trim() || !location
                          ? 0.4
                          : 1,
                      cursor:
                        isAnalyzing || !citizenStatement.trim() || !location
                  ...
                  >
                    {isAnalyzing ? (
                      <>
                        ...
                        />
                        {t(uiLang, "filingRouting")}
                      </>
                    ) : !location ? (
                      t(uiLang, "captureToEnable")
                    ) : (
                      <>
                        <Send
                          size={16}
                  ...
                  {(!location || !citizenStatement.trim()) && (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {citizenStatement.trim() ? (
                            <CheckCircle2 size={16} color="#4ade80" />
                          ) : (
                            <CircleDot size={16} color="#fca5a5" />
                          )}
                          <span
                            style={{
                              color: citizenStatement.trim()
                                ? "#4ade80"
                                : "#fca5a5",
                            }}
                          >
                            {t(uiLang, "statementRecorded")}
                          </span>
                        </div>
                        <div
                          style={{
                        ...
                        >
                          ...
                          <span
                            style={{ color: location ? "#4ade80" : "#fca5a5" }}
                          >
                            {t(uiLang, "locationCapturedReq")}
                          </span>
                        </div>
                      </div>
                    </div>
        ...
        {mode === "track" && (
          <div style={S.formWrap}>
            <div
              style={{ ...S.formPanel, maxWidth: 760 }}
              className="form-panel-glow"
            >
              <div
                style={{
                  position: "absolute",
                  ...
                  borderRadius: "28px 28px 0 0",
                  background:
                    "linear-gradient(90deg, #818cf8, #38bdf8, #818cf8)",
                  opacity: 0.5,
                }}
              />
              <div
              ...
              <div
                style={{
                  ...
                  alignItems: "center",
                  gap: 16,
                  animation: "fieldReveal 0.4s ease 0.05s both",
                }}
              >
                <div
                  style={{
              ...
              <div
                style={{
                  ...
                  display: "flex",
                  gap: 12,
                  animation: "fieldReveal 0.4s ease 0.1s both",
                }}
              >
                <input
...
const S = {
  ...
  bgOverlay: {
    ...
    inset: 0,
    background:
      "linear-gradient(to bottom,rgba(2,10,24,0.28) 0%,rgba(4,14,32,0.18) 50%,rgba(2,10,24,0.35) 100%)",
    zIndex: 7,
  },
  topBar: {
    position: "fixed",
    ...
    padding: "12px 32px",
    background:
      "linear-gradient(180deg, rgba(2,10,24,0.95), rgba(2,10,24,0.8))",
    backdropFilter: "blur(16px)",
    borderBottom: "1px solid rgba(56,189,248,0.15)",
    boxShadow: "0 8px 40px rgba(0,0,0,0.5), 0 0 60px rgba(56,189,248,0.03)",
  },
  logo: {
    fontSize: 24,
    fontWeight: 900,
    ...
    background:
      "linear-gradient(92deg,#f8fafc 0%,#38bdf8 35%,#22d3ee 55%,#818cf8 78%,#a855f7 100%)",
    backgroundSize: "200% auto",
    WebkitBackgroundClip: "text",
    WebkitTextFillColor: "transparent",
    animation: "titleFade 12s ease forwards, shimmer 6s linear infinite",
  },
  langBtn: {
    padding: "5px 10px",
    borderRadius: 8,
  ...
  heroTitle: {
    ...
    lineHeight: 1.1,
    background:
      "linear-gradient(135deg,#f8fafc 5%,#7dd3fc 30%,#a5b4fc 50%,#22d3ee 70%,#4ade80 95%)",
    backgroundSize: "200% auto",
    WebkitBackgroundClip: "text",
    WebkitTextFillColor: "transparent",
    animation: "textGlow 4s ease-in-out infinite, shimmer 6s linear infinite",
  },
  heroSub: {
    fontSize: 18,
    color: "#94a3b8",
  ...
  modeCard: {
    ...
    borderRadius: 24,
    background:
      "linear-gradient(160deg, rgba(8,22,44,0.92), rgba(5,14,30,0.97))",
    border: "1px solid rgba(99,102,241,0.15)",
    borderTop: "1px solid rgba(186,230,253,0.22)",
    cursor: "pointer",
    boxShadow:
      "0 24px 60px rgba(2,8,22,0.7), inset 0 1px 0 rgba(186,230,253,0.1)",
    position: "relative",
    overflow: "hidden",
  },
  modeCardIcon: {
  ...
  formPanel: {
    ...
    maxWidth: 1100,
    background:
      "linear-gradient(160deg, rgba(6,16,33,0.94), rgba(4,12,24,0.97))",
    backdropFilter: "blur(16px)",
    borderRadius: 28,
    border: "1px solid rgba(56,189,248,0.12)",
    borderTop: "2px solid rgba(186,230,253,0.2)",
    padding: "52px 60px",
    boxShadow:
      "0 40px 100px rgba(0,0,0,0.5), 0 0 80px rgba(56,189,248,0.03), inset 0 1px 0 rgba(186,230,253,0.06)",
  ...
  panelTitle: {
    ...
    marginBottom: 8,
    background:
      "linear-gradient(135deg, #f8fafc 25%, #7dd3fc 70%, #a5b4fc 100%)",
    WebkitBackgroundClip: "text",
    WebkitTextFillColor: "transparent",
  },
  panelSub: {
  ...
  inp: {
    ...
    outline: "none",
    fontFamily: "inherit",
    boxShadow: "inset 0 0 0 1px rgba(2,132,199,0.08)",
  ...
  micStartBtn: {
    ...
    padding: "20px",
    borderRadius: 16,
    background: "linear-gradient(135deg,#7c3aed,#a855f7,#818cf8)",
    ...
    letterSpacing: 0.5,
    boxShadow:
      "0 10px 30px rgba(124,58,237,0.3), 0 0 60px rgba(124,58,237,0.1), inset 0 1px 0 rgba(255,255,255,0.15)",
    transition: "transform 0.3s, box-shadow 0.3s",
    fontFamily: "inherit",
  },
  listeningBox: {
    background:
      "linear-gradient(160deg, rgba(2,6,23,0.97), rgba(8,15,32,0.97))",
    border: "1px solid rgba(14,165,233,0.25)",
    borderRadius: 24,
    padding: "36px 32px",
    boxShadow:
      "0 0 40px rgba(14,165,233,0.08), 0 20px 60px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.04)",
  },
  recDot: {
    width: 12,
    height: 12,
  ...
  locationBtn: {
    ...
    fontFamily: "inherit",
    transition:
      "background 0.4s, border-color 0.4s, color 0.4s, box-shadow 0.4s",
    display: "flex",
    alignItems: "center",
    gap: 8,
  },
  ...
  submitBtn: {
    ...
    fontFamily: "inherit",
    boxShadow:
      "0 12px 40px rgba(14,165,233,0.3), 0 0 80px rgba(99,102,241,0.08), 0 0 0 1px rgba(56,189,248,0.15), inset 0 1px 0 rgba(255,255,255,0.1)",
    position: "relative",
    overflow: "hidden",
  },
  resultCard: {
    ...
    borderRadius: 24,
    background:
      "linear-gradient(160deg, rgba(5,12,26,0.85), rgba(3,8,18,0.92))",
    border: "1px solid rgba(56,189,248,0.2)",
    boxShadow:
      "0 20px 60px rgba(0,0,0,0.5), 0 0 40px rgba(56,189,248,0.05), inset 0 1px 0 rgba(186,230,253,0.06)",
